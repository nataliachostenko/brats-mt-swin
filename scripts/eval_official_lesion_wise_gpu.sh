#!/bin/bash
#SBATCH --job-name=eval_official_lesion_wise_gpu
#SBATCH --account=ab0995
#SBATCH --partition=gpu
#SBATCH --nodes=1
#SBATCH --gpus=1
#SBATCH --time=08:00:00
#SBATCH --output=/work/ab0995/a270263/mgr/logs/eval_official_lesion_wise_gpu_%j.out
...
mkdir -p /work/ab0995/a270263/mgr/scratch/run_full
cd /work/ab0995/a270263/mgr/scratch/run_full
