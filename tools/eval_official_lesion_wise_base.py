...
def main(cfg: DictConfig):
    ...
    print("Loading model")
    net = BaseSwinUNETR(in_channels=4, out_channels=4, feature_size=48)
    ...
    if len(patient_dfs) > 0:
        ...
        raw_filename = f"official_lesionwise_base{suffix}_raw.csv"
        summary_filename = f"official_lesionwise_base{suffix}_summary.csv"
